  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "hero-gradient text-white shadow-lg hover:shadow-xl transform hover:scale-105 animate-pulse-glow border-0",
        education: "bg-tertiary text-tertiary-foreground shadow-md hover:bg-tertiary/90 hover:shadow-lg transform hover:scale-105",
        success: "bg-secondary text-secondary-foreground shadow-md hover:bg-secondary/90 hover:shadow-lg glow-secondary",
      },
      size: {
